 ...
 */
@Generated("")
@GraphQLName("SXPParameterContributorDefinition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SXPParameterContributorDefinition")
public class SXPParameterContributorDefinition implements Serializable {
	...
	public static SXPParameterContributorDefinition unsafeToDTO(String json) {
	...
	public String toString() {
		...
		if (templateVariable != null) {
			...
			sb.append(_escape(templateVariable));
