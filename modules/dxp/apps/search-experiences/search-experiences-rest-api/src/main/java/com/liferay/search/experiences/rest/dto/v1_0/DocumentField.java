...
public class DocumentField implements Serializable {
	...
	public static DocumentField toDTO(String json) {
		return ObjectMapperUtil.readValue(DocumentField.class, json);
	}

	public static DocumentField unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DocumentField.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.DocumentField",
		name = "x-class-name"
	)
