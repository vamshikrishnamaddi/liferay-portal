 ...
 */
@Generated("")
@GraphQLName("ModelPrefilterContributor")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ModelPrefilterContributor")
public class ModelPrefilterContributor implements Serializable {

	public static ModelPrefilterContributor toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ModelPrefilterContributor.class, json);
	}

	public static ModelPrefilterContributor unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.ModelPrefilterContributor",
		name = "x-class-name"
	)
