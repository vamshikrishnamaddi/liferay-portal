 ...
 */
@Generated("")
@GraphQLName("ParameterConfiguration")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ParameterConfiguration")
public class ParameterConfiguration implements Serializable {

	public static ParameterConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(ParameterConfiguration.class, json);
	}

	public static ParameterConfiguration unsafeToDTO(String json) {
