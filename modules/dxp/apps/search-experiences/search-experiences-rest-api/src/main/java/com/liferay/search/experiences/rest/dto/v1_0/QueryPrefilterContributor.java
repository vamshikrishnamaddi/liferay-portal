 ...
 */
@Generated("")
@GraphQLName("QueryPrefilterContributor")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "QueryPrefilterContributor")
public class QueryPrefilterContributor implements Serializable {

	public static QueryPrefilterContributor toDTO(String json) {
		return ObjectMapperUtil.readValue(
			QueryPrefilterContributor.class, json);
	}

	public static QueryPrefilterContributor unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.QueryPrefilterContributor",
		name = "x-class-name"
	)
