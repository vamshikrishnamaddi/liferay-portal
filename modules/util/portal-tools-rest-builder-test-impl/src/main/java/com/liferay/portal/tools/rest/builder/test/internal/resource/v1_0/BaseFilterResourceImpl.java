...
public abstract class BaseFilterResourceImpl
	implements EntityModelResource, FilterResource,
			   VulcanBatchEngineTaskItemDelegate<Filter> {
	...
	@javax.ws.rs.Path("/filters/export-batch")
	@javax.ws.rs.POST
	...
	public Response postFiltersPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				Filter.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	...
	public void create(
			Collection<Filter> filters, Map<String, Serializable> parameters)
		throws Exception {
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<Filter>, UnsafeFunction<Filter, Filter, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<Filter>, UnsafeConsumer<Filter, Exception>, Exception>
