...
@Generated("")
public class SortResourceFactoryImpl implements SortResource.Factory {

	@Override
	public SortResource.Builder create() {
		return new SortResource.Builder() {

			@Override
			public SortResource build() {
				if (_user == null) {
					throw new IllegalArgumentException("User is not set");
				}

				Function<InvocationHandler, SortResource>
					sortResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_sortResourceProxyProviderFunction;

				return sortResourceProxyProviderFunction.apply(
			...
			@Override
			public SortResource.Builder checkPermissions(
			...
			@Override
			public SortResource.Builder httpServletRequest(
			...
			@Override
			public SortResource.Builder httpServletResponse(
			...
			@Override
			public SortResource.Builder preferredLocale(
			...
			@Override
			public SortResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public SortResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, SortResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SortResource.class.getClassLoader(), SortResource.class);

		try {
			Constructor<SortResource> constructor =
				(Constructor<SortResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(sortResource);
	...
	private ComponentServiceObjects<SortResource> _componentServiceObjects;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, SortResource>
			_sortResourceProxyProviderFunction = _getProxyProviderFunction();
