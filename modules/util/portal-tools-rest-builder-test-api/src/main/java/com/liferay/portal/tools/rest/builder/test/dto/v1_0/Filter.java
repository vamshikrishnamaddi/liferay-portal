...
public class Filter implements Serializable {
	...
	public Integer getMaxResults() {
		if (_maxResultsSupplier != null) {
			maxResults = _maxResultsSupplier.get();

			_maxResultsSupplier = null;
		}
	...
	public void setMaxResults(
		...
		_maxResultsSupplier = () -> {
			try {
				return maxResultsUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<Integer> _maxResultsSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.Filter",
		name = "x-class-name"
	)
