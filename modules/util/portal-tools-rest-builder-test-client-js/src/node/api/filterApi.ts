...
export class FilterApi {
	...
	public setApiKey(key: FilterApiApiKeys, value: string) {
		(this.authentications as any)[FilterApiApiKeys[key]].apiKey =
			value;
	}
	...
	public addInterceptor(interceptor: Interceptor) {
		...
		public async getFiltersPage(
			...
			const localVarPath = this.basePath + '/test/v1.0/filters'
;
			...
			return interceptorPromise.then(() => {
				...
				return new Promise<{  body: PageFilter; response: http.IncomingMessage;}>((resolve, reject) => {
