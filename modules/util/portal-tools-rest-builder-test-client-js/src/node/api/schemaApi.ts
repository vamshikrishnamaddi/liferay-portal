...
import {
	...
	VoidAuth,
		...
		import {PageSchema} from '../model/pageSchema';
...
export class SchemaApi {
	...
	public setApiKey(key: SchemaApiApiKeys, value: string) {
		(this.authentications as any)[SchemaApiApiKeys[key]].apiKey =
			value;
	}
	...
	public addInterceptor(interceptor: Interceptor) {
		...
		public async getSchemasPage(
			...
			const localVarPath = this.basePath + '/test/v1.0/schemas'
;
			...
			return interceptorPromise.then(() => {
				...
				return new Promise<{  body: PageSchema; response: http.IncomingMessage;}>((resolve, reject) => {
