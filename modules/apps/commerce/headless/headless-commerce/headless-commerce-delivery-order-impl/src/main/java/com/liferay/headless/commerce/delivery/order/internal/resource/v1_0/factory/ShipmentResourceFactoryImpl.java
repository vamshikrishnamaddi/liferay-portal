 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-delivery-order/v1.0/Shipment",
...
public class ShipmentResourceFactoryImpl implements ShipmentResource.Factory {
	...
	@Override
	public ShipmentResource.Builder create() {
		return new ShipmentResource.Builder() {
			...
			@Override
			public ShipmentResource.Builder checkPermissions(
			...
			@Override
			public ShipmentResource.Builder httpServletRequest(
			...
			@Override
			public ShipmentResource.Builder httpServletResponse(
			...
			@Override
			public ShipmentResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(shipmentResource);
	...
	private ComponentServiceObjects<ShipmentResource> _componentServiceObjects;
