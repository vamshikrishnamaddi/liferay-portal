...
public interface ShipmentResource {
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderByExternalReferenceCodeShipmentsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse getPlacedOrderShipmentsPageHttpResponse(
			Long placedOrderId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;

	public void postPlacedOrderShipmentsPageExportBatch(
			Long placedOrderId, String search, String filterString,
	...
	public HttpInvoker.HttpResponse
			postPlacedOrderShipmentsPageExportBatchHttpResponse(
				Long placedOrderId, String search, String filterString,
				String sortString, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class ShipmentResourceImpl implements ShipmentResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/by-externalReferenceCode/{externalReferenceCode}/shipments");
		...
		public Page<Shipment> getPlacedOrderShipmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderShipmentsPageHttpResponse(
		...
		public HttpInvoker.HttpResponse getPlacedOrderShipmentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/shipments");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/shipments/export-batch");
