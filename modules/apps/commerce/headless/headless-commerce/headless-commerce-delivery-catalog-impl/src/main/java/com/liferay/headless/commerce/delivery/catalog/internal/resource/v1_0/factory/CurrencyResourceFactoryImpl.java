 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-delivery-catalog/v1.0/Currency",
	service = CurrencyResource.Factory.class
)
@Generated("")
public class CurrencyResourceFactoryImpl implements CurrencyResource.Factory {

	@Override
	public CurrencyResource.Builder create() {
		return new CurrencyResource.Builder() {
			...
			public CurrencyResource build() {
				...
				Function<InvocationHandler, CurrencyResource>
					currencyResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_currencyResourceProxyProviderFunction;
			...
			@Override
			public CurrencyResource.Builder checkPermissions(
			...
			@Override
			public CurrencyResource.Builder httpServletRequest(
			...
			@Override
			public CurrencyResource.Builder httpServletResponse(
			...
			@Override
			public CurrencyResource.Builder preferredLocale(
			...
			@Override
			public CurrencyResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public CurrencyResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, CurrencyResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CurrencyResource.class.getClassLoader(), CurrencyResource.class);

		try {
			Constructor<CurrencyResource> constructor =
				(Constructor<CurrencyResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(currencyResource);
	...
	private ComponentServiceObjects<CurrencyResource> _componentServiceObjects;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, CurrencyResource>
			_currencyResourceProxyProviderFunction =
				_getProxyProviderFunction();
