 ...
 */
@Generated("")
@GraphQLName("ObjectDefinitionSetting")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectDefinitionSetting")
public class ObjectDefinitionSetting implements Serializable {

	public static ObjectDefinitionSetting toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectDefinitionSetting.class, json);
	}

	public static ObjectDefinitionSetting unsafeToDTO(String json) {
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), objectDefinitionSetting.toString());
	}
