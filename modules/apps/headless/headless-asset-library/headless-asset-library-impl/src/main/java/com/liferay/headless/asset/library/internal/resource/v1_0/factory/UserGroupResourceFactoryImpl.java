 ...
 */
@Component(
	property = "resource.locator.key=/headless-asset-library/v1.0/UserGroup",
...
public class UserGroupResourceFactoryImpl implements UserGroupResource.Factory {
	...
	@Override
	public UserGroupResource.Builder create() {
		return new UserGroupResource.Builder() {
			...
			public UserGroupResource build() {
				...
				Function<InvocationHandler, UserGroupResource>
					userGroupResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_userGroupResourceProxyProviderFunction;

				return userGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public UserGroupResource.Builder checkPermissions(
			...
			@Override
			public UserGroupResource.Builder httpServletRequest(
			...
			@Override
			public UserGroupResource.Builder httpServletResponse(
			...
			@Override
			public UserGroupResource.Builder preferredLocale(
			...
			@Override
			public UserGroupResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public UserGroupResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, UserGroupResource>
		...
		try {
			Constructor<UserGroupResource> constructor =
				(Constructor<UserGroupResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(userGroupResource);
	...
	private ComponentServiceObjects<UserGroupResource> _componentServiceObjects;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, UserGroupResource>
			_userGroupResourceProxyProviderFunction =
				_getProxyProviderFunction();
