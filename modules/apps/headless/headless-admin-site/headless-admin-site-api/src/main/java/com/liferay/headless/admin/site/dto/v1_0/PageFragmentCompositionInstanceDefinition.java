...
@Generated("")
@GraphQLName(
	description = "The definition of a page fragment composition instance.",
	value = "PageFragmentCompositionInstanceDefinition"
)
...
public class PageFragmentCompositionInstanceDefinition implements Serializable {
	...
	public static PageFragmentCompositionInstanceDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			PageFragmentCompositionInstanceDefinition.class, json);
	}

	public static PageFragmentCompositionInstanceDefinition unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageFragmentCompositionInstanceDefinition",
		name = "x-class-name"
	)
