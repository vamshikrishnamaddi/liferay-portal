...
@Generated("")
@GraphQLName(
	description = "A composition of fragments that can be added to a site page.",
	value = "FragmentComposition"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FragmentComposition")
public class FragmentComposition implements Serializable {

	public static FragmentComposition toDTO(String json) {
		return ObjectMapperUtil.readValue(FragmentComposition.class, json);
	}
	...
	@GraphQLField(description = "The description of this fragment composition.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The fragment composition's key.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The fragment composition's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The fragment composition's thumbnail.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
