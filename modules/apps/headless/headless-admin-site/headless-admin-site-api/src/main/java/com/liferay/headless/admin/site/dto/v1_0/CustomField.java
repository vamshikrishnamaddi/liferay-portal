...
@Generated("")
@GraphQLName(
	description = "The value of each custom field. Fields can contain different information types (e.g., geolocation, strings, etc.).",
	value = "CustomField"
)
...
public class CustomField implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CustomField",
		name = "x-class-name"
	)
