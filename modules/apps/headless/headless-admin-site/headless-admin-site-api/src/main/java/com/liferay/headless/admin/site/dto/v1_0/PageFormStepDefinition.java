...
@Generated("")
@GraphQLName(
	description = "The definition of a page form step.",
	value = "PageFormStepDefinition"
)
...
public class PageFormStepDefinition implements Serializable {
	...
	public static PageFormStepDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PageFormStepDefinition.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageFormStepDefinition",
		name = "x-class-name"
	)
