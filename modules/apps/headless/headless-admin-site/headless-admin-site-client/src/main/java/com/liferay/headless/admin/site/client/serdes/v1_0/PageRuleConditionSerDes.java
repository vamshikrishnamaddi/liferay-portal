...
public class PageRuleConditionSerDes {
	...
	public static String toJSON(PageRuleCondition pageRuleCondition) {
		...
		if (pageRuleCondition.getExternalReferenceCode() != null) {
			...
			sb.append(_escape(pageRuleCondition.getExternalReferenceCode()));
	...
	public static Map<String, String> toMap(
		...
		if (pageRuleCondition.getExternalReferenceCode() == null) {
			...
			map.put(
				...
				String.valueOf(pageRuleCondition.getExternalReferenceCode()));
		}
	...
	public static class PageRuleConditionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "condition")) {
				...
				if (jsonParserFieldValue != null) {
					pageRuleCondition.setExternalReferenceCode(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "type")) {
